...
public class UpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
                ...
                UserId = view.findViewById(R.id.up_user_id);
                UserName = view.findViewById(R.id.up_user_name);
                UserEmail = view.findViewById(R.id.up_user_email);

                BnUpdate = view.findViewById(R.id.bn_user_update);
